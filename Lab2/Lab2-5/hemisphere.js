...
window.onload = function init()
{
    ...
    ele.oninput = ele.onchange = function (event) {
    	pos = (event.srcElement || event.target).value;
      	document.getElementById("posval").innerHTML = pos;
   };
   ele.value = 0.0;
   document.getElementById("posval").innerHTML = 0.0;
